...
use crate::experiments::{
    gen_default_char_quants, gen_default_raw_params, gen_default_viscosity, CellGroup, Experiment,
    GroupLayout,
};
...
fn group_layout(num_cells: u32, char_quants: &CharQuantities) -> Result<GroupLayout, String> {
...
fn cell_groups(cq: &CharQuantities) -> Vec<CellGroup> {
    ...
    vec![CellGroup {
        ...
        parameters: gen_default_raw_params().gen_parameters(cq),
    }]
}
