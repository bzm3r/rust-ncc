...
FORCE_COLORS = ["darkslategrey", "purple", "olivedrab", "darkgoldenrod"]
...
LABEL_COLOR_DICT.update(zip(hio.DIFFUSION, DIFFUSION_COLORS))
...
ALL_LABELS = hio.BASICS + hio.FORCES + EXTRA_POSITIONS + EXTRA_FORCES + \
             ...
             hio.CALC_KGTPS_RAC + hio.DIFFUSION + hio.OTHERS
